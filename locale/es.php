...
$langArray = array(
    ...
    "notes" => "
			...
			<ol>
				...
				<li>Los campos que se piden en estos ejercicios son un subconjunto de los definidos en la cabecera IP y en los mensajes de DNS.</li>
			  ...
			  <li>Recuerda que tienes el Mapa Mental Aumentado de DNS <a href=\"https://mapamentalar1.web.uah.es/02-canvas/dns.html\">aquí</a> por si algo no te queda claro.</li>
			  <li>El formato de los mensajes que se piden en estos ejercicios no tienen relación con los que se podrían pedir en un examen de AR1.</li>
			</ol>
	 ",
    "enun" => "
           <ul>
    ...
    "authors" => "<h3>Autores</h3>		  <ul>
			  ...
			  <li>Enrique de la Hoz de la Hoz: panel de administración, ideas de mejora y seguridad.</li>
		  </ul>",
    ...
    "ex_2_title" => "Ejercicio 2 - Nivel medio",
