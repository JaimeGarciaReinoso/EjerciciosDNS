...
<title>Ejercicio DNS 1 - Parte 2</title>
<link rel="stylesheet" href="style.css">

</head>
<body>

	<p> Ejercicio 1 - Parte 2 </p>
	<p> Tras la petición anterior, y sabiendo que todos los equipos han guardado la información recibida, el cliente desea conocer la IPcorreo del servidor correo.uah.es. Represente los mensajes intercambiados por todos los equipos hasta que el cliente reciba dicha IP.</p>

<div id="tableContainer" style="position: relative; display: inline-block;">


<form action="check.php" method="POST">
	<input type="hidden" id="ExerciseID" name="ExerciseID" value="2">
  <table id="formTable">
