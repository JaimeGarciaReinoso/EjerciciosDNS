...
<title>Ejercicio DNS 2 - Parte 2</title>
<link rel="stylesheet" href="style.css">
</head>
<body>

	<p> Ejercicio 2 - Parte 2 </p>
	<p> Después del intercambio anterior, y sabiendo que todos los equipos tienen menoria caché y han guardado los registros recibidos en el intercambio anterior, muestre los mensajes DNS enviados por el cliente cuando pide la dirección IPv4 de correo.uah.es, que es IPcorreo.</p>
<div id="tableContainer" style="position: relative; display: inline-block;">


<form action="check.php" method="POST">
	<input type="hidden" id="ExerciseID" name="ExerciseID" value="4">
  <table id="formTable">
